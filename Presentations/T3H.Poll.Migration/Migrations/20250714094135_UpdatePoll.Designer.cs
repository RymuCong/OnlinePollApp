...
namespace T3H.Poll.Migration.Migrations
{
    ...
    [Migration("20250714094135_UpdatePoll")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("T3H.Poll.Domain.Entities.PollAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("SingleChoiceId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("T3H.Poll.Domain.Entities.PollAnswerChoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PollAnswerId", "ChoiceId")
                        .IsUnique();

                    b.ToTable("PollAnswerChoice", (string)null);
                });
            ...
            modelBuilder.Entity("T3H.Poll.Domain.Entities.PollSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PollSubmissions", (string)null);
                });
            ...
            modelBuilder.Entity("T3H.Poll.Domain.Entities.PollAnswer", b =>
                {
                    ...
                    b.HasOne("T3H.Poll.Domain.Entities.Choice", "SingleChoice")
                        .WithMany()
                        .HasForeignKey("SingleChoiceId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("T3H.Poll.Domain.Entities.PollSubmission", "Submission")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("T3H.Poll.Domain.Entities.PollAnswerChoice", b =>
                {
                    ...
                    b.HasOne("T3H.Poll.Domain.Entities.PollAnswer", "PollAnswer")
